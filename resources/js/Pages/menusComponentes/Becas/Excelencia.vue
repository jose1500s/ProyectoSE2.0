  ...
  methods: {
    ...
    registrarBecaEA() {
      ...
      if (
        ...
        this.$inertia.post("/registro-beca-excelencia-academica", data, {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
            this.productDialog = false;
    ...
    editarBecaEA() {
      ...
      if (
        ...
        this.$inertia.post(`/editar-beca-excelencia-academica/${this.product.id}`, data2, {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
    ...
    deleteProduct() {
      ...
      this.$inertia.post(`/eliminar-beca-excelencia-academica/${this.product.id}`, data2, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
    ...
    deleteSelectedProducts() {
      ...
      this.$inertia.post("/eliminar-becas-excelencia-academicas", data, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
    ...
    subirExcel() {
      ...
      if (input.files[0].type != "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") {
        ...
        readXlsxFile(input.files[0]).then((rows) => {
          ...
          for (let i = 0; i < this.datosExcel.length; i++) { this.datosExcel[i][6] = "excelencia"}
