...
export default {
    ...
    importarExcel() {
      ...
      this.$inertia.post("/importar-excel-titulados-carreras", data, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
...
<template>
    <Toolbar class="mb-4">
      <template #start>
        <Button v-if="hasPermission('registrar_titulados')"
        ...
        <Button v-else disabled
          ...
          @click="openNew"
        />
        <Button v-if="hasPermission('eliminar_titulados')"
          label="Eliminar"
          icon="pi pi-trash"
    ...
    <DataTable
        ...
        <Column :exportable="false" style="min-width: 8rem" class="p-6">
          <template #body="slotProps">
            ...
            <Button v-else icon="pi pi-trash" class="p-button-rounded p-button-warning"
              @click="confirmDeleteProduct(slotProps.data)" />
          </template>
        </Column>
        <template #empty>
