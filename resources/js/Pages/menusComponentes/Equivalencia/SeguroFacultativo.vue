...
import GraficaEquivalencia from "@/Pages/menusComponentes/Equivalencia/GraficaEquivalencia.vue";
// PrimeVue
  ...
  methods: {
    ...
    registrarEquivalencia2() {
      ...
      if (
        ...
        this.$inertia.post("/registro-Equivalencia2", data, {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
            this.productDialog = false;
    ...
    editarEquivalencia2() {
      ...
      if (
        ...
        this.$inertia.post(`/editar-Equivalencia2/${this.product.id}`, data, {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
    ...
    deleteProduct() {
      ...
      this.$inertia.post(`/eliminar-Equivalencia2/${this.product.id}`, data2, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
    ...
    deleteSelectedProducts() {
      ...
      this.$inertia.post(`/eliminar-Equivalencias2/${this.product.id}`, data, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
...
<template>
  ...
  <Dialog v-model:visible="productDialog" :breakpoints="{ '960px': '75vw', '640px': '85vw' }" :style="{ width: '25vw' }"
    ...
    <div class="field">
      <form @submit.prevent="registrarEquivalencia2">
        <!-- select con opciones -->
    ...
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 p-[20px]">
      ...
      <Dialog header="Editar Equivalencia" v-model:visible="editDialog" :breakpoints="{ '960px': '75vw', '75vw': '85vw' }"
        ...
        <div class="p-fluid p-formgrid p-grid">
          <form @submit.prevent="editarEquivalencia2">
