...
import GraficaTotales from "./GraficaTotales.vue";
// PrimeVue
  ...
  methods: {
    ...
    registrarTemporal() {
      ...
      if (
        ...
        this.$inertia.post("/registro-baja-total", data, {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
            this.productDialog = false;
    ...
    editarTemporal() {
      ...
      if (
        ...
        this.$inertia.post(`/editar-baja-total/${this.product.id}`, data2, {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
    ...
    deleteProduct() {
      ...
      this.$inertia.post(`/eliminar-baja-total/${this.product.id}`, data2, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
    ...
    deleteSelectedProducts() {
      ...
      this.$inertia.post("/eliminar-bajas-totales", data, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
    ...
    importarExcel() {
      ...
      this.$inertia.post("/importar-excel-bajas-totales", data, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
...
<template>
<<<<<<< HEAD:resources/js/Pages/menusComponentes/Bajas/Totales.vue
  <Toolbar class="mb-4">
    <template #start>
...
=======
    ...
    <Toolbar class="mb-4">
      <template #start>
        <Button v-if="hasPermission('registrar_becas')"
        ...
        <Button v-else disabled
          ...
          @click="openNew"
        />
        <Button v-if="hasPermission('eliminar_becas')"
          label="Eliminar"
          icon="pi pi-trash"
        ...
        />
>>>>>>> 110d6c1665173eac4f7eaa1c4347a0e9cf341702:resources/js/Pages/menusComponentes/Becas/Proyecto.vue
  ...
  <section class="bg-white" id="tablaEgreso">
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 p-[20px]">
      ...
      <DataTable :value="totales" :paginator="true" class="p-datatable-customers" :rows="7" ref="dt"
...
<<<<<<< HEAD:resources/js/Pages/menusComponentes/Bajas/Totales.vue
  ...
  <Dialog header="Gráfica dinámica" v-model:visible="displayResponsive" 
    ...
    <div class="w-full" id="contenedorGrafica">
      <GraficaTotales :data="selectedProducts" />
    </div>
    <template #footer>
...
=======
        ...
        >
          ...
          <Column :exportable="false" style="min-width: 8rem" class="p-6">
            <template #body="slotProps">
              <Button v-if="hasPermission('editar_becas')"
                icon="pi pi-pencil"
        ...
        >
          <div class="p-fluid p-formgrid p-grid">
            <form @submit.prevent="editarBecaPP">
              <InputText id="id" v-model.trim="product.id" required="true" hidden/>
