...
=======
    ...
    <Toolbar class="mb-4">
      <template #start>
        <Button v-if="hasPermission('registrar_bajas')" label="Nuevo Registro" icon="pi pi-plus" class="p-button-success !mr-2" @click="openNew"/>
        ...
        />
        <Button
        v-if="hasPermission('eliminar_bajas')"
          label="Eliminar"
          icon="pi pi-trash"
...
>>>>>>> 110d6c1665173eac4f7eaa1c4347a0e9cf341702
    ...
    <div class="field">
      <form @submit.prevent="registrarAcademica">
        ...
        <div class="field col-12 md:col-3 mt-3">
          ...
          <Dropdown v-model="BACperiodo" :options="cuatriLista" optionLabel="name" optionValue="code"
        ...
        <div class="field col-12 md:col-3">
          ...
          <Dropdown v-model="BACcarrera" :options="carrerasLista" optionLabel="name" optionValue="code" :filter="true"
            placeholder="Seleccione" />
        </div>
  ...
  <section class="bg-white" id="tablaEgreso">
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 p-[20px]">
      ...
      <DataTable :value="academica" :paginator="true" class="p-datatable-customers" :rows="7" ref="dt"
      ...
      <Dialog header="Editar Baja" v-model:visible="editDialog" :breakpoints="{ '960px': '75vw', '75vw': '85vw' }"
        ...
        <div class="p-fluid p-formgrid p-grid">
          <form @submit.prevent="editarAcademica">
            ...
            <div class="field col-12 md:col-3">
              <label for="minmax">Hombres</label>
              <InputNumber inputId="minmax" v-model="BAChombres" mode="decimal" :min="0" :max="10000"
                :showButtons="true" />
            </div>

            <div class="field col-12 md:col-3">
              <label for="minmax">Mujeres</label>
              <InputNumber inputId="minmax" v-model="BACmujeres" mode="decimal" :min="0" :max="10000"
                :showButtons="true" />
            </div>
...
=======
        ...
        >
          ...
          <Column :exportable="false" style="min-width: 8rem" class="p-6">
            <template #body="slotProps">
              <Button
              v-if="hasPermission('editar_bajas')"
                icon="pi pi-pencil"
