  ...
  methods: {
    ...
    registrarTemporal() {
      ...
      if (
        ...
        this.$inertia.post("/registro-baja-temporal", data, {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
            this.productDialog = false;
    ...
    editarTemporal() {
      ...
      if (
        ...
        this.$inertia.post(`/editar-baja-temporal/${this.product.id}`, data2, {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
    ...
    deleteProduct() {
      ...
      this.$inertia.post(`/eliminar-baja-temporal/${this.product.id}`, data2, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
    ...
    deleteSelectedProducts() {
      ...
      this.$inertia.post("/eliminar-bajas-temporales", data, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
...
<template>
  ...
  <section class="bg-white" id="tablaEgreso">
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 p-[20px]">
      ...
      <DataTable :value="temporal" :paginator="true" class="p-datatable-customers" :rows="7" ref="dt"
