  ...
  methods: {
    ...
    registrarTemporal() {
      ...
      if (
        ...
        this.$inertia.post("/registro-baja-total-carreras", data, {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
            this.productDialog = false;
    ...
    editarTemporal() {
      ...
      if (
        ...
        this.$inertia.post(`/editar-baja-total-carreras/${this.product.id}`, data2, {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
    ...
    deleteSelectedProducts() {
      ...
      this.$inertia.post("/eliminar-bajas-totales-carreras", data, {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
