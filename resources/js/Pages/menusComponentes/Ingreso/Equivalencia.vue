...
export default {
  ...
  methods: {
    filtrarCarreras() {
      ...
      const carreras = this.equivalencias.map(item => item.carrera);
    ...
    filtrarProcesos() {
      // filtar del arreglo ingresos.carrera, todos los que se repiten
      // y retornar un arreglo con los nombres de las carreras sin repetir
      const procesos = this.equivalencias.map(item => item.Proceso);
    ...
    filtrarFecha() {
      // filtar del arreglo ingresos.carrera, todos los que se repiten
      // y retornar un arreglo con los nombres de las carreras sin repetir
      const fechas = this.equivalencias.map(item => item.fecha);
        ...
        <div class="flex gap-5 justify-center flex-wrap">
          ...
          <Dialog header="Grafica" v-model:visible="displayResponsive" :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
            ...
            <div class="w-full" id="contenedorGrafica">
              <GraficaIngreso :ingresos="equivalencias" />
            </div>
            <template #footer>
