...
<template>
  ...
  <section class="bg-white" id="tablaIngreso">
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 p-[20px]">
      ...
      <DataTable :value="ningresos" :paginator="true" class="p-datatable-customers" :rows="7" ref="dt"
        ...
        <Column field="totalingreso" header="Total de Ingresos" :sortable="true"></Column>
