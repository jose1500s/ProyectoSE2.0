    ...
    setup() {
        ...
        const confirmPosition = (position) => {
            confirm.require({
                ...
                reject: () => {
                    toast.add({ severity: 'error', summary: 'Cancelado', detail: 'Cancelo el cierre de sesion', life: 3000 });
                }
            });
        }
...
<template>
    ...
    <div class="accountLinks absolute right-0">
        <Dropdown align="right" width="48">
            <template #trigger>
                ...
                <span v-else class="inline-flex rounded-md">
                    <button type="button"
                        class="inline-flex items-center px-3 py-2 border border-transparent text-lg leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition">
    ...
    <div class=" absolute left-0 h-screen flex">
        <div class="fixed h-screen top-0  md:flex md:flex-shrink-0 border-r-2 border-gray-100">
                    ...
                    <div class="flex flex-col flex-grow px-4 mt-5">
                        <nav class="flex-1 space-y-1 bg-white">
                            ...
                            <ul>
                                <li>
                                    <Link
                                        class="inline-flex items-center w-full px-4 py-2 mt-1 text-base text-gray-900 transition duration-500 ease-in-out transform rounded-lg bg-gray-50 hover:bg-gray-200 focus:shadow-outline hover:cursor-pointer text-center"
                                ...
                                <li>
                                    <Link
                                        class="inline-flex items-center w-full px-4 py-2 mt-1 text-base text-gray-900 transition duration-500 ease-in-out transform rounded-lg bg-gray-50 hover:bg-gray-200 focus:shadow-outline hover:cursor-pointer"
                                        white="" href="#" active="">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                <li>
                                    ...
                                    <span class="ml-4"> Matricula</span>
                                    </Link>
                                </li>
                                        ...
                                        <div class="card">
                                            <div class="grid flex-column">
                                                <div class="p-col flex justify-center gap-5 mt-5">
                                                    ...
                                                    <Button @click="confirmPosition('bottomleft')" icon="pi pi-sign-out" class="p-button-rounded p-button-secondary" />
