 ...
 */
class tb_transporte_solicitudes_seleccionadosFactory extends Factory
{
    /**
    ...
    public function definition()
    {
        return [
            ...
            'hombres' => $this->faker->numberBetween(0,25),
            'mujeres' => $this->faker->numberBetween(0,25),
            'seleccionados' => $this->faker->numberBetween(30,50),
